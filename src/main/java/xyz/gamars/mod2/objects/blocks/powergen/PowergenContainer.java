package xyz.gamars.mod2.objects.blocks.powergen;
...
public class PowergenContainer extends AbstractContainerMenu {
    ...
    public PowergenContainer(int windowId, BlockPos pos, Inventory playerInventory, Player player) {
        super(AdvancedBlockInit.POWERGEN_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, AdvancedBlockInit.POWERGEN_BLOCK.get());
    }
